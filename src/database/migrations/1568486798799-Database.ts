...
export class Database1568486798799 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "editor" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "lastPinIssued" TIMESTAMP, "secret" character varying, "level" "editor_level_enum" NOT NULL DEFAULT '0', "subjects" character varying NOT NULL, CONSTRAINT "UQ_a2311562cf1ee2d7e5919170e2d" UNIQUE ("email"), CONSTRAINT "PK_354bcbcb0b7526a79230987d6e4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "editor_teams_team" ("editorId" uuid NOT NULL, "teamId" uuid NOT NULL, CONSTRAINT "PK_0cb60dbabe09069d03a5fb7ebc3" PRIMARY KEY ("editorId", "teamId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_8bc8ecf4abfc189d9764d0c4cb" ON "editor_teams_team" ("editorId") `);
        await queryRunner.query(`CREATE INDEX "IDX_93c429ef3dd37897085f713c5d" ON "editor_teams_team" ("teamId") `);
        ...
        await queryRunner.query(`ALTER TABLE "editor_teams_team" ADD CONSTRAINT "FK_8bc8ecf4abfc189d9764d0c4cbd" FOREIGN KEY ("editorId") REFERENCES "editor"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "editor_teams_team" ADD CONSTRAINT "FK_93c429ef3dd37897085f713c5d7" FOREIGN KEY ("teamId") REFERENCES "team"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "editor_teams_team" DROP CONSTRAINT "FK_93c429ef3dd37897085f713c5d7"`);
        await queryRunner.query(`ALTER TABLE "editor_teams_team" DROP CONSTRAINT "FK_8bc8ecf4abfc189d9764d0c4cbd"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_93c429ef3dd37897085f713c5d"`);
        await queryRunner.query(`DROP INDEX "IDX_8bc8ecf4abfc189d9764d0c4cb"`);
        await queryRunner.query(`DROP TABLE "editor_teams_team"`);
