...
export class Database1566496650935 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "article" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "type" "article_type_enum" NOT NULL DEFAULT 'Review Article', "status" "article_status_enum" NOT NULL DEFAULT 'Submitted', "subject" "article_subject_enum" NOT NULL, "docId" character varying NOT NULL, "deadline" TIMESTAMP, "notes" character varying, "folderId" character varying NOT NULL, "markingGridId" character varying NOT NULL, "copyright" character varying, "trashed" boolean NOT NULL DEFAULT false, "summary" character varying, "reason" character varying, "modified" TIMESTAMP NOT NULL DEFAULT now(), "wordpress_id" integer, CONSTRAINT "PK_40808690eb7b915046558c0f81b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "subject" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, CONSTRAINT "PK_12eee115462e38d62e5455fc054" PRIMARY KEY ("id"))`);
