...
export class Database1564943700354 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "author" ("id" uuid NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "secret" character varying, "token" character varying, "school" character varying NOT NULL, "biography" character varying NOT NULL, "country" character varying NOT NULL, "teacher" character varying NOT NULL, "profile" character varying NOT NULL, CONSTRAINT "PK_5a0e79799d372fe56f2f3fa6871" PRIMARY KEY ("id"))`);
